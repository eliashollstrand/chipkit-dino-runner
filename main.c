...
int main(void)
{
	...
	// T2CON = 0x8070; // Clear T2CON to ensure a clean start
	// // T2CONSET = 0x70; // Set the prescaler to 1:256 (bit 6 and 7)
	// TMR2 = 0xFFFF; // Clear the timer counter
	// PR2 = 31250;   // Set the period register for 100 ms (assuming a 80 MHz clock)
	// 			   // Enable Timer 2 (T2)
	// 			   // T2CONSET = 0x8000;
